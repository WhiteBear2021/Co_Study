						...
						<div class="card-body">
							<form>
								...
								<div class="form-group col-md-2">
									...
									<input type="text" disabled class="form-control" name="user_no" value="${studygroup.studygroup_user_no }">
								</div>
								...
								<div class="form-group col-md-3">
									...
									<input type="text" disabled class="form-control" name="categori_no" value="${studygroup.categori_no }">
								</div>
								<div class="form-group col-md-2">
								...
								<div class="form-group col-md-1">
									...
									<input type="text" disabled class="form-control" name="report_number" value="${studygroup.report_number }">
								</div>
								<div style="text-align: center;">
